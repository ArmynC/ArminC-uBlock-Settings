...
| EasyPrivacy                     | Ryanbr, Monzta, Famlam and Khrin | Web bugs, tracking scripts and information collectors.                                                                                                              | [LINK](https://github.com/easylist/easylist/tree/master/easyprivacy)                          |
| Fanboy's Enhanced Tracking List | Ryanbr                           | Common tracking scripts.                                                                                                                                            | [LINK](https://fanboy.co.nz/filters.html)                                                     |
| Malware Domains                 | RiskAnalytics                    | Domains that are known to be used to propagate malware.                                                                                                             | [LINK](https://www.malwaredomains.com/?page_id=66)                                            |
...
| Fanboy's Cookie List            | Ryanbr                           | Cookie and privacy warnings.                                                                                                                                        | [LINK](https://fanboy.co.nz/index.html)                                                       |
...
| Toxic Domains                                              | StopForumSpam Community              | Domains used to abuse.                                                                                                                           | [LINK](https://www.stopforumspam.com/downloads)                                                  |
| DShield.org Suspicious Domain List - Low                   | DandelionSprout                      | Low Level Sensitivity website.                                                                                                                   | [LINK](https://dshield.org/suspicious_domains.html)                                              |
...
| Anti popads.net                                            | Yhonay                               | Popads.net domains.                                                                                                                              | [LINK](https://github.com/Yhonay/antipopads/)                                                    |
| CoinBlockerLists                                           | ZeroDot1                             | Browser based miners.                                                                                                                            | [LINK](https://gitlab.com/ZeroDot1/CoinBlockerLists)                                             |
| EasyList - Lite                                            | AdBlock Team                         | Adverts from international webpages.                                                                                                             | [LINK](https://help.getadblock.com/support/solutions/articles/6000142821-what-is-easylist-lite-) |
| Fuck Fuckadblock                                           | Bogachenko Vyacheslav                | Pop-ups and anti-adblock bypass.                                                                                                                 | [LINK](https://github.com/bogachenko/fuckfuckadblock)                                            |
...
| I don't care about cookies                                 | Daniel Kladnik                       | Annoying cookie warnings.                                                                                                                        | [LINK](https://www.i-dont-care-about-cookies.eu/)                                                |
| Lightswitch05's Ads & Tracking                             | Daniel White                         | Analytics, Ads, and tracking hosts.                                                                                                              | [LINK](https://github.com/lightswitch05/hosts)                                                   |
| Lightswitch05's AMP Hosts                                  | Daniel White                         | AMP pages.                                                                                                                                       | [LINK](https://github.com/lightswitch05/hosts)                                                   |
| IpLoggerFilter                                             | Piperun                              | Site/subsite whose only purpose is to log the IP.                                                                                                | [LINK](https://github.com/piperun/iploggerfilter)                                                |
| Web Annoyances Ultralist - CSS Style Modifying Filters     | Yourduskquibbles                     | Site elements that block screen real estate.                                                                                                     | [LINK](https://github.com/yourduskquibbles/webannoyances/tree/master/filters)                    |
